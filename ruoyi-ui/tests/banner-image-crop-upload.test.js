...
assert(/fixed-number=["']\[112,\s*55\]["']/.test(cropper), '裁剪框比例应固定为112:55')
assert(/canvas\.width\s*=\s*1120/.test(cropper), '输出画布宽度应为1120像素')
assert(/canvas\.height\s*=\s*550/.test(cropper), '输出画布高度应为550像素')
